...
exports.TwaManifest = exports.asOrientation = exports.Orientations = exports.asDisplayMode = exports.DisplayModes = void 0;
const fs = require("fs");
...
class TwaManifest {
    constructor(data) {
        ...
        this.navigationColorDark = new Color((_a = data.navigationColorDark) !== null && _a !== void 0 ? _a : DEFAULT_NAVIGATION_COLOR);
        this.navigationDividerColor = new Color((_b = data.navigationDividerColor) !== null && _b !== void 0 ? _b : DEFAULT_NAVIGATION_DIVIDER_COLOR);
        this.navigationDividerColorDark = new Color((_c = data.navigationDividerColorDark) !== null && _c !== void 0 ? _c : DEFAULT_NAVIGATION_COLOR);
    ...
    validate() {
        let error;
        error = util_1.validateNotEmpty(this.host, 'host');
        if (error != null) {
            return error;
        }
        error = util_1.validateNotEmpty(this.name, 'name');
        if (error != null) {
            return error;
        }
        error = util_1.validateNotEmpty(this.startUrl, 'startUrl');
        if (error != null) {
            return error;
        }
        if (!this.iconUrl) {
        ...
        error = util_1.validateNotEmpty(this.iconUrl, 'iconUrl');
        if (error != null) {
            return error;
        }
        return error;
    ...
    static fromWebManifestJson(webManifestUrl, webManifest) {
        var _a;
        const icon = util_1.findSuitableIcon(webManifest.icons, 'any', MIN_ICON_SIZE);
        const maskableIcon = util_1.findSuitableIcon(webManifest.icons, 'maskable', MIN_ICON_SIZE);
        const monochromeIcon = util_1.findSuitableIcon(webManifest.icons, 'monochrome', MIN_NOTIFICATION_ICON_SIZE);
        ...
        const twaManifest = new TwaManifest({
            packageId: util_1.generatePackageId(webManifestUrl.host) || '',
            host: webManifestUrl.host,
            name: webManifest['name'] || webManifest['short_name'] || DEFAULT_APP_NAME,
            launcherName: webManifest['short_name'] || ((_a = webManifest['name']) === null || _a === void 0 ? void 0 : _a.substring(0, SHORT_NAME_MAX_SIZE)) || DEFAULT_APP_NAME,
    ...
    static getNewIconUrl(fieldsToIgnore, fieldName, oldUrl, icons, iconType, iconSize, webManifestUrl) {
        ...
        return (fieldsToIgnore.includes(fieldName)) ? oldUrl :
            resolveIconUrl(util_1.findSuitableIcon(icons, iconType, iconSize));
    }
    /**
    ...
    static async merge(fieldsToIgnore, webManifestUrl, webManifest, oldTwaManifest) {
        ...
        const twaManifest = new TwaManifest({
            ...
            launcherName: this.getNewFieldValue('short_name', fieldsToIgnore, oldTwaManifest.launcherName, webManifest['short_name'] || ((_a = webManifest['name']) === null || _a === void 0 ? void 0 : _a.substring(0, SHORT_NAME_MAX_SIZE))),
