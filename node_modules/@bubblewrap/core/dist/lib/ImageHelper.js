...
class ImageHelper {
     ...
     */
    async generateIcon(icon, targetDir, iconDef, backgroundColor) {
    ...
    async fetchIcon(iconUrl) {
        ...
        if (contentType.startsWith('image/svg')) {
            ...
            try {
                body = await svg2img_1.svg2img(textDecoder.decode(body));
            }
            catch (error) {
