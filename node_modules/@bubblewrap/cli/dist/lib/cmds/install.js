...
async function install(args, config, log = new core_1.ConsoleLog('install')) {
    ...
    const originalArgs = process.argv.slice(3).filter((v) => !v.startsWith(APK_FILE_PARAM) && PARAMETERS_TO_IGNORE.indexOf(v) < 0);
